...
quelleslangues=c("Lithuanian","Czech","German","French","Russian","AmericanEnglish","Italian","Austrian","Ukrainian","Spanish","Polish",
                 "English","NewZealand","Chinese","HongKong","Taiwan","Japanese")
...
Contraintesages=list(list(c(4,6),c(150,200)),list(c(17,16),c(25,125)))
...
save.image(paste("EuropeAsieBNZ", date(), ".RData"), version = 2)
