...
f = "je_languages_modified2.csv"
J = read.csv(f, na.strings = c("", "NA"), stringsAsFactors = T)
...
quelleslangues = unique(J$Language)
...
quelmeanings = unique(J$Meaning) # TOFILL
...
save.image(paste("JePhylo", date(), ".RData"), version = 2)
